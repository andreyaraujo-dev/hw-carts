  ...
  return (
    <main className="flex items-center w-screen h-screen justify-center">
      <aside className="h-full w-1/2 p-5 flex flex-col justify-center text-start">
        <h1 className="text-4xl font-bold text-start">HW Carts</h1>
        <p className="text-xl">
          Gerencie a sua coleção de carrinhos da HotWheels.
        </p>
        <p className="text-lg">Tenha sua coleção na palma da sua mão.</p>
      </aside>
      <aside className="h-full w-1/2 p-5 flex items-center justify-center">
